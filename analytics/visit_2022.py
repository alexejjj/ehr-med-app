...
params = {
    "q": "SELECT e/ehr_id/value, c/uid/value, c/archetype_details/template_id/value, o1/data[at1234]/events["
         ...
         "WHERE c/uid/value = '2a88ab36-04ed-4ea1-93c9-09e79c5d3743::local.ehrbase.org::1' LIMIT 1",
    "format": "json"}
...
for state in patient_states_cleaned:
    ehr_id_2022 = state['ehr_id']
    visit_date_2022 = state['visit_date']
    element_size_x_2022 = state['element_size_x']
    element_size_y_2022 = state['element_size_y']
    element_area_2022 = state['element_area']
    height_2022 = state['height']
    weight_2022 = state['weight']
