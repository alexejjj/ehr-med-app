...
params = {
    "q": "SELECT e/ehr_id/value, c/uid/value, c/archetype_details/template_id/value, o1/data[at1234]/events["
         ...
         "WHERE c/uid/value = 'c2a26767-a8e8-4ce5-be5b-8b4565a2cbe4::local.ehrbase.org::1' LIMIT 1",
    "format": "json"}
...
for state in patient_states_cleaned:
    ehr_id_2021 = state['ehr_id']
    visit_date_2021 = state['visit_date']
    element_size_x_2021 = state['element_size_x']
    element_size_y_2021 = state['element_size_y']
    element_area_2021 = state['element_area']
    height_2021 = state['height']
    weight_2021 = state['weight']
